...
class TestSimpleRequests(unittest.TestCase):
    ...
    def test_simpleCourseQuestions(self):
        ...
        self.assertEqual("Kursuse Arvutimängude loomine ja disain ainekood on MTAT.03.263", bot.getResponse(words)["answer"])
    ...
    def test_whatisQuestions(self):
        ...
        self.assertEqual("Antud koodi kasutab struktuuriüksus: arvutiteaduse instituut.", bot.getResponse(sentence)["answer"])
    ...
    def test_ExtraQuestions(self):
        ...
        self.assertTrue(bot.getResponse(sentence)["answer"].startswith("Mulle tundub, et sa tahtsid küsida infot kursuse kohta. Kursuse kohta saad küsida"))
        sentence = "eap"
    ...
    def test_descriptionQuestion(self):
        ...
        self.assertTrue(
            bot.getResponse(sentence)["answer"].startswith("Aine Tarkvaraprojekt(LTAT.05.005) kirjeldus:\nTarkvara arendustöö"))

    def test_objectiveQuestion(self):
        bot = cbot.chatbot()
        sentence = "Mis on tarkvaraprojekti eesmärk?"
        self.assertTrue(
            bot.getResponse(sentence)["answer"].startswith("Aine Tarkvaraprojekt(LTAT.05.005) eesmärk:\nKursuse eesmärgiks"))
    ...
    def test_gradeQuestion(self):
        ...
        self.assertTrue(
            bot.getResponse(sentence)["answer"].startswith("Aine Tarkvaratehnika(LTAT.05.003) hindamine on Eristav (A, B, C, D, E, F, mi)"))
